...
function fillUpdateFormWithVaccinationData(vaccination) {
  ...
  document.getElementById("vaccinationFacilityIDToUpdate").value =
    vaccination.FacilityID;
  document.getElementById("vaccinationTypeToUpdate").value =
    vaccination.VaccinationType;
  document.getElementById("vaccinationDateToUpdate").value = formatDate(
